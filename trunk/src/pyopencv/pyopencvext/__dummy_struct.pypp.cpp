...
void register___dummy_struct_class(){
    ...
    }
    {
        ...
        bp::def("asCvRect", &::normal_cast< ::cv::Rect_< double >, ::CvRect >, (bp::arg("inst_Rectd")));
        bp::def("asCvRect", &::normal_cast< ::cv::Rect_< float >, ::CvRect >, (bp::arg("inst_Rectf")));
        bp::def("asRectf", &::normal_cast< ::cv::Rect_<int>, ::cv::Rect_<float> >, (bp::arg("inst_Rect")));
        bp::def("asRectd", &::normal_cast< ::cv::Rect_<int>, ::cv::Rect_<double> >, (bp::arg("inst_Rect")));
        bp::def("asRect", &::normal_cast< ::cv::Rect_<float>, ::cv::Rect_<int> >, (bp::arg("inst_Rectf")));
        bp::def("asRectd", &::normal_cast< ::cv::Rect_<float>, ::cv::Rect_<double> >, (bp::arg("inst_Rectf")));
        bp::def("asRect", &::normal_cast< ::cv::Rect_<double>, ::cv::Rect_<int> >, (bp::arg("inst_Rectd")));
        bp::def("asRectf", &::normal_cast< ::cv::Rect_<double>, ::cv::Rect_<float> >, (bp::arg("inst_Rectd")));
        bp::def("asCvBox2D", &::normal_cast< ::cv::RotatedRect, ::CvBox2D >, (bp::arg("inst_RotatedRect")));
        bp::def("asCvScalar", &::normal_cast< ::cv::Scalar_< double >, ::CvScalar >, (bp::arg("inst_Scalar__less__double__greater_")));
