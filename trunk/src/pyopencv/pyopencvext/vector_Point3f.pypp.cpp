...
#include "vector_Point3f.pypp.hpp"

namespace bp = boost::python;

static inline void resize(::std::vector< cv::Point3_<float> > &inst, size_t num) { inst.resize(num); }
...
void register_vector_Point3f_class(){
    ...
    { //::std::vector< cv::Point3_<float> >
        ...
        vector_Point3f_exposer.def("resize", &::resize, ( bp::arg("num") ));
    }
