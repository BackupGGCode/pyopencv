...
struct CvSeqReader_wrapper : CvSeqReader, bp::wrapper< CvSeqReader > {

    CvSeqReader_wrapper(CvSeqReader const & arg )
    : CvSeqReader( arg )
      , bp::wrapper< CvSeqReader >(){
        // copy constructor
...
void register_CvSeqReader_class(){
    ...
    bp::class_< CvSeqReader_wrapper >( "CvSeqReader" )    
        ...
        .add_property( "prev_elem", bp::make_function(&::CvSeqReader_wrapper::get_prev_elem) );
