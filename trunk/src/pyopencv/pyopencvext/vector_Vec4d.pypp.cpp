...
#include "vector_Vec4d.pypp.hpp"

namespace bp = boost::python;

static inline void resize(::std::vector< cv::Vec<double, 4> > &inst, size_t num) { inst.resize(num); }
...
void register_vector_Vec4d_class(){
    ...
    { //::std::vector< cv::Vec<double, 4> >
        ...
        vector_Vec4d_exposer.def("resize", &::resize, ( bp::arg("num") ));
    }
