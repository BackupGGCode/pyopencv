...
#include "vector_Vec3w.pypp.hpp"

namespace bp = boost::python;

static inline void resize(::std::vector< cv::Vec<unsigned short, 3> > &inst, size_t num) { inst.resize(num); }
...
void register_vector_Vec3w_class(){
    ...
    { //::std::vector< cv::Vec<unsigned short, 3> >
        ...
        vector_Vec3w_exposer.def("resize", &::resize, ( bp::arg("num") ));
    }
