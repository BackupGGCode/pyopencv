...
void register_MSER_class(){
    ...
    bp::class_< cv::MSER, bp::bases< CvMSERParams > >( "MSER", bp::init< >() )    
        ...
        .def( 
            ...
            , "[PyOpenCV] Argument 'msers' is a list. To convert a Mat into a list, invoke one of its member functions preceeding with 'to_list_of_...'"\
    "\n[PyOpenCV] Argument 'msers' is an output argument and is omitted from the function's calling sequence." );
