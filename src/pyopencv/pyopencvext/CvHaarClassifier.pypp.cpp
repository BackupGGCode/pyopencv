...
{
    cv::Mat threshold2;
    convert_from_array_of_T_to_Mat(inst.threshold, inst.count, threshold2);
    return threshold2;
}
...
{
    cv::Mat left2;
    convert_from_array_of_T_to_Mat(inst.left, inst.count, left2);
    return left2;
}
...
{
    cv::Mat right2;
    convert_from_array_of_T_to_Mat(inst.right, inst.count, right2);
    return right2;
}
...
{
    cv::Mat alpha2;
    convert_from_array_of_T_to_Mat(inst.alpha, inst.count, alpha2);
    return alpha2;
}
