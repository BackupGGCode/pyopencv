...
#include "vector_Vec4f.pypp.hpp"

namespace bp = boost::python;

static inline void resize(::std::vector< cv::Vec<float, 4> > &inst, size_t num) { inst.resize(num); }
...
void register_vector_Vec4f_class(){
    ...
    { //::std::vector< cv::Vec<float, 4> >
        ...
        vector_Vec4f_exposer.def("resize", &::resize, ( bp::arg("num") ));
    }
