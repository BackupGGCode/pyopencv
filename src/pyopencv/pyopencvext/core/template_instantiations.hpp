...
public:
    ...
    static int const var214 = sizeof(std::vector<cv::Vec<unsigned char,3> >);
    static int const var216 = sizeof(cv::Vec<double,6>);
    static int const var218 = sizeof(cv::Point3_<float>);
    static int const var220 = sizeof(cv::Scalar_<double>);
    static int const var222 = sizeof(cv::Vec<float,6>);
    static int const var225 = sizeof(std::vector<unsigned char *>);
    static int const var226 = sizeof(std::vector<cv::Range>);
    static int const var227 = sizeof(cv::Ptr<cv::FilterEngine>);
    static int const var228 = sizeof(cv::Ptr<CvMemStorage>);
    static int const var229 = sizeof(std::vector<cv::Point_<double> >);
    static int const var231 = sizeof(std::vector<cv::CascadeClassifier::DTree>);
    static int const var239 = sizeof(cv::Vec<unsigned short,4>);
    static int const var242 = sizeof(cv::Ptr<cv::BaseRowFilter>);
    static int const var244 = sizeof(std::vector<std::vector<cv::Point_<int> > >);
    static int const var245 = sizeof(std::vector<std::vector<cv::Point3_<float> > >);
};
