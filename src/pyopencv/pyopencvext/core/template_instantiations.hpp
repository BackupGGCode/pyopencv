...
public:
    ...
    static int const var48 = sizeof(cv::Vec<unsigned short,2>);
    static int const var50 = sizeof(std::vector<int>);
    static int const var55 = sizeof(std::vector<unsigned long long>);
    ...
    static int const var115 = sizeof(std::vector<cv::KDTree::Node>);
    ...
    static int const var140 = sizeof(cv::Point_<float>);
    static int const var141 = sizeof(cv::Size_<float>);
    static int const var148 = sizeof(std::vector<cv::CascadeClassifier::DTreeNode>);
