...
#include "vector_Point2d.pypp.hpp"

namespace bp = boost::python;

static inline void resize(::std::vector< cv::Point_<double> > &inst, size_t num) { inst.resize(num); }

void register_vector_Point2d_class(){
    ...
    { //::std::vector< cv::Point_<double> >
        ...
        vector_Point2d_exposer.def("resize", &::resize, ( bp::arg("num") ));
    }
