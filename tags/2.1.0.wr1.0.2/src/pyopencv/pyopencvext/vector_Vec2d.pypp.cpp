...
#include "vector_Vec2d.pypp.hpp"

namespace bp = boost::python;

static inline void resize(::std::vector< cv::Vec<double, 2> > &inst, size_t num) { inst.resize(num); }

void register_vector_Vec2d_class(){
    ...
    { //::std::vector< cv::Vec<double, 2> >
        ...
        vector_Vec2d_exposer.def("resize", &::resize, ( bp::arg("num") ));
    }
